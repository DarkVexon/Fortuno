...
import static theGambler.FortunoCharacter.Enums.GAMBLER_COLOR;
import static theGambler.FortunoMod.*;

public class FortunoCharacter extends CustomPlayer {
    ...
    public FortunoCharacter(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new FortunoCharacter(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_GAMBLER;
        @SpireEnum(name = "GAMBLER_COLOR")
        public static AbstractCard.CardColor GAMBLER_COLOR;
        @SpireEnum(name = "GAMBLER_COLOR")
